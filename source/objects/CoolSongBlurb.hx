...
class CoolSongBlurb extends FlxSpriteGroup
{
    ...
    public function new(songName:String = '', songComp:String = '')
    {
        ...
        dataName.text = "Now Playing: " + songName + " (" + CoolUtil.difficultyString().toUpperCase() + ")";
        dataName.updateHitbox();
        dataName.scrollFactor.set();
        dataName.alpha = 0;
        dataName.antialiasing = ClientPrefs.globalAntialiasing;
        ...
        dataComp.alpha = 0;
        dataComp.antialiasing = ClientPrefs.globalAntialiasing;
